...
class ModernPortfolio {
  ...
  setupCustomCursor() {
    ...
    const interactives = document.querySelectorAll('a, button, .project-card, .skill-card, .filter-btn, .tl-card, .pub-card');
  ...
  setupNavigation() {
    ...
    const sections = document.querySelectorAll('.section[id], .section-alt[id]');
  ...
  setupContactForm() {
    ...
    form.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        window.open(`mailto:ankit.raj@outlook.com?subject=${subject}&body=${body}`);
